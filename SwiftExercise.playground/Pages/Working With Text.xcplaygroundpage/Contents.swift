...
//qn1
let word: String = "Simform"
let wordLength: Int = strlen(word)
if wordLength >= 2 {
    print(word.prefix(2))
}
else {
...
let substring = word[indexStartSubstring...indexEndSubstring]
if wordLength >= 2 {
    print(substring)
}
else {
...
//qn3
let string1: String = "Swift"
let string2: String = "Examples"
...
//qn6
let example: String = "Simform Solutions"
