...
let code = [    "a" : "b",  "b" : "c",  "c" : "d",  "d" : "e",  "e" : "f",
                "f" : "g",  "g" : "h",  "h" : "i",  "i" : "j",  "j" : "k",
                "k" : "l",  "l" : "m",  "m" : "n",  "n" : "o",  "o" : "p",
                "p" : "q",  "q" : "r",  "r" : "s",  "s" : "t",  "t" : "u",
                "u" : "v",  "v" : "w",  "w" : "x",  "x" : "y",  "y" : "z",
                "z" : "a"]
let encodedMessage = "uijt nfttbhf jt ibse up sfbe"
var message = String()
...
//qn2
let people: [[String:String]] = [[ "firstName": "Calvin",  "lastName": "Newton" ],
...
//qn4
let peopleDict: [[String:Any]] = [[ "firstName": "Calvin", "lastName": "Newton" ,  "score": 13],
