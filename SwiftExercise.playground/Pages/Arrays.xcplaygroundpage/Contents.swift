...
//qn2
var givenArray: [Int] = [1,2,3,4]
var new: Array<Int> = Array(repeating: 0, count: givenArray.count*2)
var countGivenArray: Int = givenArray.count
var countNewArray: Int = new.count
...
var max = integersArray.max()
print("Maximum = \(max!)")


//qn5----
var sortedIntegers: [Int] = [0,5,6,2,10]
